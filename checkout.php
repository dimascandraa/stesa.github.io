...
<head>
	<title>STESAOFFICIAL | Checkout</title>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1"><form method="post">
						...
						<td class="invert"><?php echo $b['idwarna'] ?></td>
						<td class="invert">
							 <div class="quantity"> 
			...
			<hr>
			<br><center>
			<h2>Total harga yang tertera di atas sudah termasuk ongkos kirim sebesar Rp10.000<br>Bila telah melakukan pembayaran, harap konfirmasikan pembayaran Anda.</h2>
			<br>
