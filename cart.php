...
<head>
	<title>STESAOFFICIAL | Keranjangsaya</title>
			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1"><form method="post">
						...
						<td class="invert">
								<input type="text" name="jumlah" value="<?php echo $b['idwarna'] ?>">
							</td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                     
									<input type="number" name="jumlah" height="100px" value="<?php echo $b['qty'] ?>" \>
								</div>
							</div>
						</td>
